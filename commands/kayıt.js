...
module.exports = {
   ...
   const Fatih = new Discord.MessageEmbed()
   ...
   Kullanıcı daha önce kayıt olduğu isimleri görmek için \`isimler @Fatih/id\` komutunu kullanabilirsin.
   
   `)
   .setAuthor(message.guild.name, message.guild.iconURL({ dynamic: true, size: 2048 }))
   .setColor("RANDOM")
   .setFooter(ayarlar.footer)
    let msg = message.channel.send({ embeds: [Fatih], components: [row]})
...
await i.deferUpdate();
i.editReply({ components: [man2], embeds: [Fatih]})
